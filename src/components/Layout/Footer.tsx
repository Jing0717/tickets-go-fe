      ...
      <div className="container">
        <div className="flex flex-col md:flex-row text-gray-03 text-sm">
          <div className="mb-4 md:max-w-[429px] md:mr-10">
            ...
            <p className='text-sm leading-4 mt-4'>在 TicketsGo，我們致力於為您提供無與倫比的購票體驗，讓您輕鬆訪問和購買各類活動的門票。 無論您是音樂會的鐵杆粉絲，體育賽事的狂熱支援者，還是劇場和藝術表演的愛好者，TicketsGo 都能滿足您的需求。</p>
          </div>
          <div className="w-full md:flex">
            <div className="flex space-x-4 mb-4 md:w-2/3">
              ...
              <div className="w-1/2">
                ...
                <ul className="flex flex-col border-t-1 border-gray-03 py-2 px-4 text-white">
                  <li className="py-2 cursor-pointer hover:text-gray-03">個人資料</li>
                  <li className="py-2 cursor-pointer hover:text-gray-03">訂票資訊</li>
                  <li className="py-2 cursor-pointer hover:text-gray-03">追蹤列表</li>
                </ul>
              </div>
            </div>
